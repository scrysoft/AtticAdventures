...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.207981,0.213542,0.202420,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,10.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.207981,0.213542,0.202420,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.050000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local4 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,sampler_Material_Texture2D_0,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local5 = MaterialStoreTexSample(Parameters, Local4, 0);
	MaterialFloat Local6 = (Local4.r * Material.PreshaderBuffer[4].y);
	MaterialFloat Local7 = saturate(Local6);
	MaterialFloat3 Local8 = lerp(Material.PreshaderBuffer[6].xyz,Material.PreshaderBuffer[5].xyz,Local7);
	MaterialFloat Local9 = lerp(Material.PreshaderBuffer[7].x,Material.PreshaderBuffer[6].w,Local7);
