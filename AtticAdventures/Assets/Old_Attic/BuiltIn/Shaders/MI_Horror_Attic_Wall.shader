Shader "Unreal/MI_Horror_Attic_Wall"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,3.000000,-2.000000,20.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.400000,1.000000);//(Unknown)
