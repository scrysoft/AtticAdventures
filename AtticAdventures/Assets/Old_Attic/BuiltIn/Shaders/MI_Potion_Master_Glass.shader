Shader "Unreal/MI_Potion_Master_Glass"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.682292,0.682292,0.682292,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.682292,0.682292,0.682292,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(2.000000,0.100000,0.500000,1.090000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Material.PreshaderBuffer[4].w,Material.PreshaderBuffer[5].x);
