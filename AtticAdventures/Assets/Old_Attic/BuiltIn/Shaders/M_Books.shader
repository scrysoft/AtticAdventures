Shader "Unreal/M_Books"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Books_BC", 2D ) = "white" {}
		Material_Texture2D_1( "T_Dirt_01_02", 2D ) = "white" {}
		Material_Texture2D_2( "T_Books_AO_R_MT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.505882,0.368627,0.274510,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,10.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.505882,0.368627,0.274510,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local10 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)Material.PreshaderBuffer[5].x));
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local10), 2);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local10),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 2);
	MaterialFloat Local14 = (Local12.r * Material.PreshaderBuffer[5].y);
	MaterialFloat Local15 = saturate(Local14);
	MaterialFloat3 Local16 = lerp(Local9,Material.PreshaderBuffer[6].xyz,Local15);
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local18 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 0);
	MaterialFloat Local20 = (Local18.g * Material.PreshaderBuffer[6].w);
	MaterialFloat Local21 = lerp(Local20,Material.PreshaderBuffer[7].x,Local15);
