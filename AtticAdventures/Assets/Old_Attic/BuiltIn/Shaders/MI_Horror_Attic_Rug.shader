Shader "Unreal/MI_Horror_Attic_Rug"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,190.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.527778,3.316126,0.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(5.000000,10.000000,0.000000,0.000000);//(Unknown)
