Shader "Unreal/MI_WoodBeam_09"
{
	Properties
	{
		...
		Material_Texture2D_3( "T_Dirt_01_02", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,1.000000,0.000000,20.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.500000,0.500000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,340.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.944444,5.934119,0.300000,0.600000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.639216,0.639216,0.639216,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,10.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.639216,0.639216,0.639216,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 4);
	MaterialFloat4 Local9 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local19 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local25 = (Local24 * ((MaterialFloat3)Material.PreshaderBuffer[4].w));
	MaterialFloat2 Local26 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[6].x));
	MaterialFloat Local27 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local26), 3);
	MaterialFloat4 Local28 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local26),View.MaterialTextureMipBias));
	MaterialFloat Local29 = MaterialStoreTexSample(Parameters, Local28, 3);
	MaterialFloat Local30 = (Local28.r * Material.PreshaderBuffer[6].y);
	MaterialFloat Local31 = saturate(Local30);
	MaterialFloat3 Local32 = lerp(Local25,Material.PreshaderBuffer[7].xyz,Local31);
	MaterialFloat Local33 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local34 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local35 = MaterialStoreTexSample(Parameters, Local34, 0);
	MaterialFloat Local36 = lerp(Material.PreshaderBuffer[8].x,Material.PreshaderBuffer[7].w,Local31);
	MaterialFloat Local37 = (Local34.r * Material.PreshaderBuffer[8].y);

	PixelMaterialInputs.EmissiveColor = Local17;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local32;
	PixelMaterialInputs.Metallic = Local34.b;
