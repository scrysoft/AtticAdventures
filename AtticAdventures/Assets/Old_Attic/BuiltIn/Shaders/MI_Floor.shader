Shader "Unreal/MI_Floor"
{
	Properties
	{
		...
		Material_Texture2D_0( "T_Wood_Pine_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Wood_Floor_Walnut_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_Wood_Pine_D", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(15.000000,90.000000,0.250000,1.570796);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.684278);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.200000,2.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local2 = ((MaterialFloat2(0.50000000,0.50000000) * -1.00000000) + DERIV_BASE_VALUE(Local1));
	MaterialFloat Local3 = dot(DERIV_BASE_VALUE(Local2),Material.PreshaderBuffer[3].xy);
	MaterialFloat Local4 = dot(DERIV_BASE_VALUE(Local2),Material.PreshaderBuffer[3].zw);
	...
	MaterialFloat4 Local8 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 1);
	MaterialFloat Local10 = (Local8.rgb.b + 1.00000000);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 2);
	MaterialFloat4 Local12 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 2);
	MaterialFloat2 Local14 = (Local12.rgb.rg * ((MaterialFloat2)-1.00000000));
	MaterialFloat Local15 = dot(MaterialFloat3(Local8.rgb.rg,Local10),MaterialFloat3(Local14,Local12.rgb.b));
	MaterialFloat3 Local16 = (MaterialFloat3(Local8.rgb.rg,Local10) * ((MaterialFloat3)Local15));
	MaterialFloat3 Local17 = (((MaterialFloat3)Local10) * MaterialFloat3(Local14,Local12.rgb.b));
	MaterialFloat3 Local18 = (Local16 - Local17);
	MaterialFloat3 Local19 = lerp(Local18,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[4].x);
	...
	MaterialFloat3 Local20 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[5].xyz,Material.PreshaderBuffer[4].y);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 0);
	MaterialFloat4 Local22 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat Local24 = dot(Local22.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local25 = lerp(Local22.rgb,((MaterialFloat3)Local24),Material.PreshaderBuffer[5].w);
	...
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[6].y;
