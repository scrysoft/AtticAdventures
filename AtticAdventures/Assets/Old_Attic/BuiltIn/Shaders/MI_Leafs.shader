Shader "Unreal/MI_Leafs"
{
	Properties
	{
		...
		Material_Texture2D_2( "T_Leaves_OP", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.739583,0.285337,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.739583,0.285337,0.000000,0.350000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local8 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local13 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 0);
	MaterialFloat3 Local15 = (Local11 * ((MaterialFloat3)1.00000000));

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local13.rgb;
	PixelMaterialInputs.BaseColor = Local11;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[5].x;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[5].y;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[5].z;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local5;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local15,Material.PreshaderBuffer[5].w);
	PixelMaterialInputs.AmbientOcclusion = Material.PreshaderBuffer[6].y;
