Shader "Unreal/MI_Potion_Master_Liquid_Red"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(0.682353,0.682353,0.682353,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.682353,0.682353,0.682353,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.250000,0.000000,0.000000,1.330000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local0 = (View.GameTime * Material.PreshaderBuffer[2].w);
	MaterialFloat Local1 = (View.GameTime * Material.PreshaderBuffer[3].x);
	...
	MaterialFloat2 Local4 = (DERIV_BASE_VALUE(Local3) * ((MaterialFloat2)Material.PreshaderBuffer[3].y));
	...
	MaterialFloat3 Local8 = lerp(Local6.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[3].w);
	...
	MaterialFloat Local9 = (View.GameTime * 2.09439516);
	MaterialFloat Local10 = sin(Local9);
	MaterialFloat Local11 = (DERIV_BASE_VALUE(Local10) * 0.50000000);
	MaterialFloat Local12 = (DERIV_BASE_VALUE(Local11) + Material.PreshaderBuffer[4].x);
	MaterialFloat3 Local13 = (((MaterialFloat3)DERIV_BASE_VALUE(Local12)) * Material.PreshaderBuffer[7].xyz);
	MaterialFloat3 Local14 = lerp(DERIV_BASE_VALUE(Local13),Material.PreshaderBuffer[8].xyz,Material.PreshaderBuffer[7].w);
	...
	MaterialFloat Local20 = PositiveClampedPow(Local19,5.00000000);
	MaterialFloat Local21 = (Local20 * (1.00000000 - 0.04000000));
	MaterialFloat Local22 = (Local21 + 0.04000000);
	MaterialFloat Local23 = lerp(1.00000000,Material.PreshaderBuffer[11].w,Local22);

	PixelMaterialInputs.EmissiveColor = Local14;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[11].z;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[10].xyz;
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Local23,Material.PreshaderBuffer[12].x);
